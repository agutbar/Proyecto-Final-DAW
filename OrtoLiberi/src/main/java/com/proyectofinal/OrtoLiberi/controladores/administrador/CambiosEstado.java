...
public class CambiosEstado{
	 ...
	 public String mostrarCambioEstadoPedidoCliente(HttpSession session, @RequestParam Long id) {
	 ...
	 public String mostrarCambioEstadoTrabajador(HttpSession session, @RequestParam Long id) {
	 ...
	 @GetMapping("/cliente") 
	 public String mostrarCambioEstadoCliente(HttpSession session, @RequestParam Long id) {
	 ...
	 public String mostrarCambioEstadoProveedor(HttpSession session, @RequestParam Long id) {
	 ...
	 @GetMapping("/taller") 
	 public String mostrarCambioEstadoTrabajoTaller(HttpSession session, @RequestParam Long id) {
	 ...
	 public String cambiarEstadoTrabajador(Model model, @RequestParam Long id, @RequestParam String estado) {
		 Trabajador trabajador = repositorioTrabajador.findByid(id);
		 if(trabajador.getEstado() == estado) {
			 model.addAttribute("error", "Ha seleccionado el mismo estado que ya estaba asignado");
		 } else {

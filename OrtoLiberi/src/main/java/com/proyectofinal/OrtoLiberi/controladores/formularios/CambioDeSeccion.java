...
public class CambioDeSeccion {
	...
	public String nuevoUsuario(Model model, HttpServletRequest request, @RequestParam String nombre, @RequestParam String apellidos, @RequestParam String telefono, @RequestParam String direccion, @RequestParam String correo, @RequestParam String usuario, @RequestParam String password) {
		...
		if (correoCliente != null || usuarioCliente != null) {
			...
			return "redirect:/registrado/inicio";
	    }
	}
	
	@PostMapping("/cliente")
	public String iniciarSesionCliente(Model model, HttpServletRequest request, @RequestParam String usuario, @RequestParam String password) {
	...
	public String iniciarSesionTrabajador(Model model, HttpServletRequest request,  @RequestParam String codigo, @RequestParam String password) {
		...
		if (trabajador != null) {
	        ...
	        if (EncriptadoPasswords.verificarContraseña(password, empleado.getPassword())) {
	        	HttpSession session = request.getSession();
	        	session.setAttribute("trabajador", empleado);

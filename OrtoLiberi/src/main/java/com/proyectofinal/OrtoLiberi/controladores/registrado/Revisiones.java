...
public class Revisiones {
	...
	private static final String VER_DETALLES = "registrado/vistazo/ver-revision";
	...
	@GetMapping("/ver/{id}") 
	public String mostrarDetallesRevision(HttpSession session, Long id) { 
	...
	public String mostrarEdicionRevision(HttpSession session, Long id) { 
	...
	public String cancelarRevision(HttpSession session, Long id) { 
		Cliente usuario = (Cliente) session.getAttribute("usuario");
		Revision revision = repositorioRevision.findByid(id);

...
public class RealizarAcciones{
	 ...
	 public String reestablecerPassword(HttpSession session, Model model, @RequestParam String usuario, @RequestParam String password) {
		 ...
		 if(EncriptadoPasswords.verificarContraseña(password, cliente.getPassword())) {
			 ...
			 model.addAttribute("confirmacion", "Contraseña reestablecida");
		 } else {
			 model.addAttribute("error", "Fallo al reestablecer la contraseña");
		 }

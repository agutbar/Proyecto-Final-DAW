...
public class EliminarElementos {
	...
	public String borrarProducto(HttpSession session, @PathVariable Long id) {
	...
	public String borrarMaterial(HttpSession session,  @PathVariable Long id) {
		Trabajador trabajador = (Trabajador) session.getAttribute("trabajador");
	...
	@PostMapping("/baja/{id}")
	public String borrarBaja(HttpSession session,  @PathVariable Long id) {
		Trabajador trabajador = (Trabajador) session.getAttribute("trabajador");
	...
	public String borrarCliente(HttpSession session,  @PathVariable Long id) {
		Trabajador trabajador = (Trabajador) session.getAttribute("trabajador");
	...
	public String borrarPaciente(HttpSession session, @PathVariable Long id) {
		Trabajador trabajador = (Trabajador) session.getAttribute("trabajador");
	...
	public String borrarTrabajador(HttpSession session,  @PathVariable Long id) {
		Trabajador trabajador = (Trabajador) session.getAttribute("trabajador");
	...
	public String borrarProveedor(HttpSession session,  @PathVariable Long id) {
		Trabajador trabajador = (Trabajador) session.getAttribute("trabajador");
	...
	public String borrarSolicitante(HttpSession session,  @PathVariable Long id) {
		Trabajador trabajador = (Trabajador) session.getAttribute("trabajador");
	...
	public String borrarCodigo(HttpSession session,  @PathVariable String codigo) {
		Trabajador trabajador = (Trabajador) session.getAttribute("trabajador");

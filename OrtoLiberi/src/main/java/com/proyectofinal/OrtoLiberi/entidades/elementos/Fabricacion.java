...
public class Fabricacion {
	...
	@NotNull(message = "El estado debe ser asignado o no asignado")
	@Pattern(regexp= "^(asignado|no-asignado)$")
	...
	public Fabricacion(Long id,
			...
			CodigoSAS codigo, Hijo paciente, Trabajador responsable,
			@NotNull(message = "El estado debe ser asignado o no asignado") @Pattern(regexp = "^(asignado|no-asignado)$") String estado,
			Map<Long, Integer> materiales) {
		this.id = id;
		this.nombre = nombre;
	...
	public CodigoSAS getCodigo() {
		return codigo;
	}

	public void setCodigo(CodigoSAS codigo) {
		this.codigo = codigo;
	}
	...
	public String toString() {
		return "Fabricacion [id=" + id + ", nombre=" + nombre + ", descripcion=" + descripcion + ", codigo=" + codigo
				+ ", paciente=" + paciente + ", responsable=" + responsable + ", estado=" + estado + ", materiales="
				+ materiales + "]";
	}
}

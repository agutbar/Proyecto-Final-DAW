...
public class Cliente {
    ...
    //@Pattern(regexp = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%.-_*?&]{8,12}$", message = "La contraseña debe incluir al menos una mayúscula, una minúscula, un número y un carácter especial")
	...
	public Cliente(Long id,
			...
			List<Hijo> menores, List<Revision> citas, List<PedidoFabricacion> productos_taller, List<Compra> compras, List<PedidoCliente> pedidos) {
		super();
		this.id = id;
		this.nombre = nombre;

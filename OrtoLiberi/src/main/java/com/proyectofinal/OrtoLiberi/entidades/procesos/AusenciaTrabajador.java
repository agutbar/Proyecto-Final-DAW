...
public class AusenciaTrabajador {
	...
	@NotBlank(message = "La fecha de baja es obligatoria")
    private LocalDate baja;
	
	@NotBlank(message = "La fecha de alta de entrega es obligatoria")
	...
	@NotBlank(message = "Los dias de ausencia son obligatorios")

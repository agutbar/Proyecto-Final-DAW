...
document.getElementById("formulario_registro_trabajador").setAttribute("novalidate","novalidate"); //Desactivar validacion de HTML si está activo JavaScript
...
function validarRegistro(event){
    ...
    if (validarNombre() && validarApellidos() && validarTelefono() && validarFechaNacimiento() && validarCorreo() && validarDireccion()){
        document.getElementById("formulario_registro_trabajador").submit(); // Enviar el formulario si todo es válido
    }
}

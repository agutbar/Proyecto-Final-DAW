                ...
                <div class="card-body">
                    <form id="formulario_acceso_cliente" method="post" action="/formulario/cliente">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="usuario" id="inputUser"  placeholder="Escribe tu usuario..." required/>
                        ...
                        <button type="submit" class="btn btn-success btn-block" id="acceder_cliente">Iniciar Sesion</button>

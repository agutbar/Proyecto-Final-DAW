...
<head>
    ...
    <title>OrtoLiberi - Pagina de Acceso</title>
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right" id="navbarNavAltMarkup">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a class="nav-item nav-link" href="/general/tienda">Tienda</a></li>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Acceder a tu perfil</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="wrap" id="login">
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="formulario_acceso_cliente" method="post" action="/formulario/cliente">
                        <div class="form-group">
                            <label for="inputUser">Usuario</label> 
                            <input type="text" class="form-control" id="inputUser" name="usuario" placeholder="Escribe tu usuario..." required/>
							<span class="error-formulario" id="errorUsuario" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword">Contraseña</label>
                            <input type="password" class="form-control" id="inputPasswordC" name="password" placeholder="Escribe tu contraseña..." required/>
							<span class="error-formulario" id="errorPasswordC" style="font-style: italic; color: red;"></span>
                        </div>
                        <button type="button" class="btn btn-success btn-block" id="acceder_cliente">Iniciar Sesion</button>
                        <button type="submit" class="btn btn-success btn-block"><a href="/general/registro">Crear Nueva Cuenta</a></button>
                    </form>

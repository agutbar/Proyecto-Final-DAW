            ...
            <div class="card">
                <div class="card-body">
                    <form>
                        ...
                        <button type="submit" class="btn btn-success btn-block"><a href="/general/personal">Iniciar Sesion</a></button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <button type="submit" class="btn btn-success btn-block"><a href="/general/adminstracion">Acceder</a></button>
                    </form>
                </div>
            </div>
        </div>

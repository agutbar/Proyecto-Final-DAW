    ...
    <section class="wrap" id="ask-for-a-job">
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formulario_registro_solicitud_trabajo" method="post" action="/guardarSolicitud" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="inputProfileNombre">Nombre Completo:</label>
                            <input type="text" class="form-control" id="inputProfileNombre" name="nombre" placeholder="Escribe tu nombre..." required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="inputProfileEmail" name="email" placeholder="Escribe tu correo..." required/>
							<span class="error-formulario" id="errorProfileEmail" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputProfileCV">Curriculum: (Obligatorio PDF - Max. 900KB)</label>
                            <input type="file" class="form-control" id="inputProfileCV" name="curriculum" placeholder="Adjunta el curriculum..." required/>

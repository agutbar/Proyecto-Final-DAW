                ...
                <div class="card-body">
                    <form>
                        <div class="form-group">
                            <label for="inputProfileName">Nombre Completo:</label>
                            <input type="text" class="form-control" id="inputProfileName" placeholder="Escribe tu nombre..."/>
                        </div>
                        <div class="form-group">
                            <label for="inputProfileEmail">Correo Electronico de Contacto:</label>
                            <input type="email" class="form-control" id="inputProfileEmail" placeholder="Escribe tu correo..."/>
                        </div>
                        <div class="form-group">
                            <label for="inputProfileCV">Curriculum:</label>
                            <input type="file" class="form-control" id="inputProfileCV" placeholder="Adjunta el curriculum..."/>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success"><a href="#" data-bs-toggle="modal" data-bs-target="#modalConfirmacion">Enviar Solicitud</a></button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <button type="submit" class="btn btn-success btn-block"><a href="/general/administrador">Acceder</a></button>
                    </form>
                </div>
            </div>
        </div>

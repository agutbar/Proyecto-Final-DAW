...
<body>
    ...
    <section class="wrap" id="new-user">
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_cliente" method="post" action="/formulario/registro">
                        <div class="form-group">
                            <label for="inputNombre">Nombre</label>
                            <input type="text" class="form-control" id="inputNombre" name="nombre" placeholder="Escribe tu nombre..." required/>
							<span class="error-formulario" id="errorNombre" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputApellidos">Apellidos</label>
                            <input type="text" class="form-control" id="inputApellidos" name="apellidos" placeholder="Escribe tus apellidos..." required/>
							<span class="error-formulario" id="errorApellidos" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail">Email</label>
                            <input type="email" class="form-control" id="inputEmail" name="correo" placeholder="Escribe un email..." required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputTelefono" name="telefono" placeholder="Escribe tu número de telefono..." required/>
							<span class="error-formulario" id="errorTelefono" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputDireccion">Direccion</label>
                            <input type="text" class="form-control" id="inputDireccion" name="direccion" placeholder="Escribe tu direcccion..." required/>
                        ...
                        <button type="button" class="btn btn-success btn-block" id="registrar_cliente">Crear Cuenta</button>
	...
	<script src="../js/validacion_registro_cliente.js"></script>
</body>
</html>
								...
								<div class="tab-pane fade" id="cpendientes" role="tabpanel" aria-labelledby="citas-pendientes">
									...
									<div class="card-body">
										<table class="table table-striped">
											...
											<tbody>
												<tr th:each="revision : ${revisiones_pendientes}">
													<td th:text="${revision.cita.fecha}"></td>
													<td th:text="${revision.cita.hora}"></td>
													<td th:text="${revision.paciente}"></td>
													<td>
														<a href="/revision/ver/{id}(id=${revision.id})" class="btn btn-info btn-sm">Ver Detalles</a>
														<a href="/revision/editar/{id}(id=${revision.id})" class="btn btn-warning btn-sm">Editar</a>
														<a href="/revision/cancelar/{id}(id=${revision.id})" class="btn btn-danger btn-sm">Cancelar</a>
													</td>
												</tr>
											</tbody>
										</table>
								...
								<div class="tab-pane fade" id="chistorico" role="tabpanel" aria-labelledby="citas-historico">
									...
									<div class="card-body">
										<table class="table table-striped">
											...
											<tbody>
												<tr th:each="revision : ${revisiones_completadas}">
													<td th:text="${revision.cita.fecha}"></td>
													<td th:text="${revision.cita.hora}"></td>
													<td th:text="${revision.paciente}"></td>
													<td>
														<a th:href="/revision/ver/{id}(id=${cliente.id})" class="btn btn-info btn-sm">Ver Detalles</a>
													</td>
												</tr>
											</tbody>
										</table>

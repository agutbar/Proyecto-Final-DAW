    ...
    <section class="wrap" id="personal-data">
        <div class="container">
            ...
            <dl class="row">
                ...
                <dd class="col-sm-9">${hijo.tutor.nombre} ${hijo.tutor.apellidos}</dd>
            </dl>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-8 offst-sm-2">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item">
							<a class="nav-link" id="ver-trabajos-taller" data-bs-toggle="tab" href="#trabajos-taller" role="tab" aria-controls="trabajos-taller" aria-selected="false">Productos de taller</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" id="ver-citas" data-bs-toggle="tab" href="#citas" role="tab" aria-controls="citas" aria-selected="false">Revisiones</a>
						</li> 
                    </ul>
	                <div class="tab-content" id="myTabContent">
	                	<div class="tab-pane fade" id="trabajos-taller" role="tabpanel" aria-labelledby="ver-trabajos-taller">
							<table class="table table-striped">
								...
								<tbody>
									<c:forEach var="trabajo" items="${hijo.productos_realizados}">
										<tr>
						...
						<div class="tab-pane fade" id="citas" role="tabpanel" aria-labelledby="ver-citas">
							<table class="table table-striped">
								...
								<tbody>
									<c:forEach var="revision" items="${hijo.revisiones}">
										<tr>
											<td>${revision.cita.fecha}</td>
											<td>${revision.cita.hora}</td>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/ver-hijo/${hijo.id}">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

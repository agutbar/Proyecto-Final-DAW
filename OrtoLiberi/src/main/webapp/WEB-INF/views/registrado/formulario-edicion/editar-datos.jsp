...
<body>
    ...
    <section class="wrap" id="new-user">
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_cliente" method="post" action="/editar/datos">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputApellido" name="apellidos" value="${usuario.apellidos}" placeholder="Escribe tus apellidos..." required/>
							<span class="error-formulario" id="errorApellidos" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail">Email</label>
                            <input type="email" class="form-control" id="inputEmail" name="email" value="${usuario.correo}" placeholder="Escribe un email..." required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password" id="inputPassword" value="${usuario.password}" placeholder="Escribe tu contraseña..." required/>

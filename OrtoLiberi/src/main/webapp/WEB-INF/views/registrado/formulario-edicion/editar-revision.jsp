	            	...
	            	<form id="formulario_registro_revision" method="post" action="/editar/revision">
	                    ...
	                    <div class="form-group">
							...
							<select class="form-control" id="inputPaciente" th:field="*{hijo.id}" required>
								...
								<option th:each="hijo : ${cliente.menores}" th:value="${hijo.id}" th:text="${hijo.nombre} ${hijo.apellidos}"></option>
							</select>
	                    ...
	                    <button type="button" class="btn btn-success btn-block" id="registrar_revision">Editar Cita</button>
	            	</form>

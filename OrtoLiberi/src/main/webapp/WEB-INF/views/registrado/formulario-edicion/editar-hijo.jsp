...
<body>
    ...
    <section class="wrap" id="new-user">
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registrar_hijo" method="post" action="/edicion/hijo">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="inputTutor" name="tutor" value="${hijo.tutor}" required readonly/>

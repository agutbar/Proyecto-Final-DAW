        ...
        <div class="row">
            ...
            <div class="col-3" id="izquierda-regis">
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-9">00-00-0000</dd>

                    <dt class="col-sm-3">Tecnico</dt>
                    <dd class="col-sm-9">dfnojeanfv wefweFWEA</dd>
    
                    <dt class="col-sm-3">Motivo</dt>
                    <dd class="col-sm-9">fncsfcjcoifhoq</dd>
                </dl>
                <p id="boton"><a class="btn btn-warning btn-lg" href="#" data-bs-toggle="modal" data-bs-target="#modalConstruccion">Ver todas &raquo;</a></p>
            </div>
            <div class="col-6" id="centro-regis">
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-3">Coste</dt>
                    <dd class="col-sm-9">00,00€</dd>
                </dl>
                <p id="boton"><a class="btn btn-warning btn-lg" href="#" data-bs-toggle="modal" data-bs-target="#modalConstruccion">Ver todas &raquo;</a></p>
            </div>
            <div class="col-3" id="derecha-regis">
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-9">038340r2048</dd>
    
                    <dt class="col-sm-3">Articulo</dt>
                    <dd class="col-sm-9">jfsojfiejfoies</dd>
    
                    <dt class="col-sm-3">Fecha de Pedido</dt>
                    <dd class="col-sm-9">00-00-0000</dd>
                </dl>
                <p id="boton"><a class="btn btn-warning btn-lg" href="#" data-bs-toggle="modal" data-bs-target="#modalConstruccion">Ver todos &raquo;</a></p>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="perfil.jsp">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

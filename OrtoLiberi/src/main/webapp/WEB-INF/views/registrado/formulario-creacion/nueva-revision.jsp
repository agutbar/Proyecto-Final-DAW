	        	...
	        	<div class="card-body">
	            	<form id="formulario_registro_revision" method="post" action="/nuevo/revision">
	                	<div class="form-group">
	                        ...
	                        <input type="text" class="form-control" id="inputSolicitante" value="${usuario.nombre} ${usuario.apellidos}" readonly required/>
	                    ...
	                    <button type="submit" class="btn btn-success btn-block" id="registrar_revision">Pedir Cita</button>
	            	</form>

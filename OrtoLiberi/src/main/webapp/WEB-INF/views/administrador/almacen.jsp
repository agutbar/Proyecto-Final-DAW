            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right" id="navbarNavAltMarkup">
                    <ul class="nav navbar-nav">
                        <li><a class="nav-item nav-link" href="pedidos.jsp"><i class="fa-solid fa-truck-fast"></i>Pedidos</a></li>
	        ...
	        <div class="modal-dialog modal-sm">
	            <div class="modal-content">
	                ...
	                <div class="modal-body">
	                    <form>
	                        <button type="submit" class="btn btn-success btn-block"><a href="almacen.html">Volver</a></button>
	                    </form>
	                </div>
	            </div>
	        </div>
	    ...
	    <div class="modal fade" id="modalConfirmacionNuevoProducto"> <!--Ventana Modal de Confirmación de la suma de un nuevo Producto-->
	        <div class="modal-dialog modal-sm">
	            <div class="modal-content">
	                ...
	                <div class="modal-body">
	                    <form>
	                        <button type="submit" class="btn btn-success btn-block"><a href="almacen.html">Volver al almacen</a></button>
	                    </form>
	                </div>
	            </div>
	        </div>

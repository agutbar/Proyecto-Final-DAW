											...
											<tbody>
												<c:forEach var="producto" items="${productos}">
													<tr>
														...
														<td>${producto.devolución}</td>
														<td>${producto.proveedor.nombre}</td>
														<td>${producto.codigoAsociado.codigo}</td>
														<td>${producto.stock}</td>
														<td>
															<a href="/administrador/editar-producto${producto.id}" class="btn btn-warning btn-sm">Editar</a>
															<a href="/eliminar/producto/${producto.id}" class="btn btn-success btn-sm">Descatalogar</a>
															<a href="/cambio/codigo${producto.id}producto" class="btn btn-info btn-sm">Reasignar Codigo</a>
														</td>
													</tr>
												</c:forEach>
											</tbody>
											...
											<tbody>
												<c:forEach var="material" items="${materiales}">
													<tr>
														...
														<td>${material.lote}</td>
														<td>${material.caducidad}</td>
														<td>${material.coste}</td>
														<td>${material.stock}</td>
														<td>${material.proveedor.nombre}</td>
														<td>
															<a href="/administrador/editar-material${material.id}" class="btn btn-warning btn-sm">Editar</a>
															<a href="/eliminar/material/${material.id}" class="btn btn-success btn-sm">Descatalogar</a>
														</td>
													</tr>
												</c:forEach>
											</tbody>

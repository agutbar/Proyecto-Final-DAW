					...
					<div class="row">
						<div class="col-sm-8 offst-sm-2">
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item">
							    	<a class="nav-link" id="lista-productos" data-bs-toggle="tab" href="#productos" role="tab" aria-controls="productos" aria-selected="false">Productos</a>
							    </li>
							    <li class="nav-item">
							    	<a class="nav-link" id="lista-materiales" data-bs-toggle="tab" href="#materiales" role="tab" aria-controls="materiales" aria-selected="false">Materiales</a>
							   	</li>
							</ul>
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade" id="productos" role="tabpanel" aria-labelledby="lista-productos">
							    	<div class="card-heading">
			                        	<h3>Listado de Productos</h3>
			                            <p><a class="btn btn-primary btn-lg" href="/administrador/nuevo-producto">Añadir</a></p>
							       	</div>
							        <div class="card-body">
										<table class="table table-striped">
											...
											<tbody>
												<tr th:each="producto: ${productos}">
													...
													<td th:text="${producto.lote}"></td>
													<td th:text="${producto.coste}"></td>
													<td th:text="${producto.precio}"></td>
													<td th:text="${producto.devolucion}"></td>
													<td th:text="${producto.proveedor}"></td>
													<td th:text="${producto.codigo}"></td>
													<td th:text="${producto.stock}"></td>
													<td>
														<a th:href="/editar/producto/{id}(id=${producto.id})" class="btn btn-warning btn-sm">Editar</a>
														<a th:href="/eliminar/producto/{id}(id=${producto.id})" class="btn btn-success btn-sm">Descatalogar</a>
														<a th:href="/cambio/codigo/{id}/{categoria}(id=${producto.id}, categoria='producto')" class="btn btn-info btn-sm">Reasignar Codigo</a>
													</td>
												</tr>
											</tbody>
										</table>
								...
								<div class="tab-pane fade" id="materiales" role="tabpanel" aria-labelledby="lista-materiales">
							    	<div class="card-heading">
			                            ...
			                            <p><a class="btn btn-primary btn-lg" href="/administrador/nuevo-material">Añadir</a></p>
							        </div>
							        <div class="card-body">
										<table class="table table-striped">
											<thead>
											...
											<tbody>
												<tr th:each="material: ${materiales}">
													...
													<td th:text="${material.lote}"></td>
													<td th:text="${material.caducidad}"></td>
													<td th:text="${material.coste}"></td>
													<td th:text="${material.stock}"></td>
													<td th:text="${material.proveedor}"></td>
													<td>
														<a th:href="/editar/material/{id}(id=${material.id})" class="btn btn-warning btn-sm">Editar</a>
														<a th:href="/eliminar/material/{id}(id=${material.id})" class="btn btn-success btn-sm">Descatalogar</a>
													</td>
												</tr>
											</tbody>
										</table>

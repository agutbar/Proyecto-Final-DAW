				                        ...
				                        <div class="tab-pane fade" id="proximas" role="tabpanel" aria-labelledby="bajas-proximas">
				                            ...
				                            <div class="card-body">
												<table class="table table-striped">
												    ...
												    <tbody>
														<c:forEach var="proxima" items="${proximas}">
													    	<tr>
													            <td>${proxima.baja}</td>
																<td>${proxima.alta}</td>
																<td>${proxima.tecnico.nombre} ${proxima.tecnico.apellidos}</td>
																<td>${proxima.motivo}</td>
													            <td>
													            	<a href="/administrador/editar-baja${proxima.id}" class="btn btn-warning btn-sm">Editar</a>
													                <a href="/eliminar/baja/${proxima.id}" class="btn btn-danger btn-sm">Eliminar</a>
													            </td>
													         </tr>
														 </c:forEach>
												    </tbody>
										...
										<div class="tab-pane fade" id="actuales" role="tabpanel" aria-labelledby="bajas-actuales">
											...
											<div class="card-body">
												<table class="table table-striped">
													...
													<tbody>
														<c:forEach var="actual" items="${actuales}">
															<tr>
																<td>${actual.baja}</td>
																<td>${actual.alta}</td>
																<td>${actual.tecnico.nombre} ${actual.tecnico.apellidos}</td>
																<td>${actual.motivo}</td>
																<td>
																	<a href="/administrador/editar-baja${actual.id}" class="btn btn-warning btn-sm">Editar</a>
																</td>
															</tr>
														</c:forEach>
													</tbody>
										...
										<div class="tab-pane fade" id="pasadas" role="tabpanel" aria-labelledby="bajas-pasadas">
											...
											<div class="card-body">
												<table class="table table-striped">
													...
													<tbody>
														<c:forEach var="pasada" items="${pasadas}">
															<tr>
																<td>${pasada.baja}</td>
																<td>${pasada.alta}</td>
																<td>${pasada.tecnico.nombre} ${pasada.tecnico.apellidos}</td>
																<td>${pasada.motivo}</td>
															</tr>
														</c:forEach>
													</tbody>

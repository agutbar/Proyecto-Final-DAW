                ...
                <div class="card-body">
                    <form id="formulario_registro_fabricacion" method="post" action="/nuevo/fabricacion">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="inputDescripcion" name="descripción" placeholder="Escribe la descripción del producto..." required></textarea>
                        ...
                        <div class="form-group">
							...
							<select class="form-control" id="inputPaceinte" name="paciente" required>
						...
						<div class="form-group">
							...
							<select class="form-control" id="inputResponsable" name="responsable" required>
                        ...
                        <button type="submit" class="btn btn-success btn-block" id="registrar_fabricacion">Registrar</button>
                    </form>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/administrador/nueva-fabricacion">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

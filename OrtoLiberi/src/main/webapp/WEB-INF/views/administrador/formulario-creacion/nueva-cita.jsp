...
<head>
    ...
    <title>OrtoLiberi - Nueva Cita</title>
...
<body>
    ...
    <section class="wrap" id="new-user">
        <div class="container">
            ...
            <p class="lead">Añade una nueva cita a la agenda para ponerla a disposición de los clientes</p>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_cita" method="post" action="/nuevo/cita">
                        <div class="form-group">
                            <label for="inputDia">Dia</label>
                            <input type="number" class="form-control" id="inputDia" name="dia" step="1" placeholder="00" min="1" max="31" required/>
							<span class="error-formulario" id="errorDia" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputMes">Mes</label>
                            <input type="number" class="form-control" id="inputMes" name="mes" step="1" placeholder="00" min="1" max="12" required/>
							<span class="error-formulario" id="errorMes" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputYear">Año</label>
                            <input type="number" class="form-control" id="inputYear" name="year" step="1" placeholder="" min="" required/>
							<span class="error-formulario" id="errorYear" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputHora">Hora</label>
                            <input type="number" class="form-control" id="inputHora" name="hora" step="1" placeholder="00" min="9" max="20" required/>
							<span class="error-formulario" id="errorHora" style="font-style: italic; color: red;"></span>
                        </div>
						<div class="form-group">
							<label for="inputMinuto">Minuto</label>
							<input type="number" class="form-control" id="inputMinuto" name="minuto" step="1" placeholder="00" min="00" max="50" required/>
                        ...
                        <div class="form-group">
							...
							<select class="form-control" id="inputTecnico" name="trabajador" required>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/administrador/nueva-cita">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

...
<head>
    ...
    <title>OrtoLiberi - Nuevo Material</title>
...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Crear Nuevo Material</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="wrap" id="new-user">
        <div class="container">
            ...
            <p class="lead">Da de alta un nuevo material para añadir al almacen de la tienda</p>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_material" method="post" action="/nuevo/material">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputLote" name="lote" placeholder="Escribe el número de lote..." required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputStock" name="stock" placeholder="0" required/>
							<span class="error-formulario" id="errorStock" style="font-style: italic; color: red;"></span>
                        </div>
						<div class="form-group">
							<label for="inputCaducidad">Caducidad</label>
						    <input type="date" class="form-control" id="inputCaducidad" name="caducidad" required/>
							<span class="error-formulario" id="errorCaducidad" style="font-style: italic; color: red;"></span>
						</div>
                        <div class="form-group">
                            <label for="inputCoste">Coste</label>
                            <input type="number" class="form-control" id="inputCoste" name="coste" step="0.01" placeholder="0,01" required/>
							<span class="error-formulario" id="errorCoste" style="font-style: italic; color: red;"></span>
                        </div>
                        <button type="submit" class="btn btn-success btn-block" id="registrar_material">Registrar</button>
                    </form>

	            	...
	            	<form id="formulario_pedido_fabricacion" method="post" action="/nuevo/pedidoFabricacion">
	                	<div class="form-group">
							<label for="inputProducto">Producto a Fabricar</label>
								<select class="form-control" id="producto" th:field="*{fabricacion.id}" required>
									<option value="">Seleccione un Producto a Fabricar</option>
									<option th:each="fabricacion : ${fabricaciones}" th:value="${fabricacion.id}" th:text="${fabricacion.nombre} + ' para ' + ${fabricacion.paciente.nombre} ${fabricacion.paciente.apellidos}"></option>
								</select>
	                    ...
	                    <button type="button" class="btn btn-success btn-block" id="registrar_pedido_fabricacion">Hacer Pedido</button>
	           		</form>

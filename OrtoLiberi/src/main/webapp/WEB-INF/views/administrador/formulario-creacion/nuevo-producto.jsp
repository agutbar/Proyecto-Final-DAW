...
<head>
    ...
    <title>OrtoLiberi - Nuevo Producto</title>
...
<body>
    ...
    <section class="wrap" id="new-user">
        <div class="container">
            ...
            <p class="lead">Da de alta un nuevo producto para añadir al almacen de la tienda</p>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_producto" method="post" action="/nuevo/producto">
						...
						<div class="form-group">
							...
							<select class="form-control" id="inputCodigo" name="codigo" required>
                        ...
                        <div class="form-group">
							...
							<select class="form-control" id="inputDevolucion" name="devolución" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputStock" name="stock" step="1" min="1" placeholder="0" required/>
							<span class="error-formulario" id="errorCodigo" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="inputPrecio" name="venta" step="0.01" placeholder="0,01" required/>
							<span class="error-formulario" id="errorPrecio" style="font-style: italic; color: red;"></span>
						</div>
                        <button type="submit" class="btn btn-success btn-block" id="registrar_producto">Registrar</button>
                    </form>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/administrador/nuevo-producto">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

            ...
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_producto" method="post" action="/nuevo/producto">
						...
						<div class="form-group">
							<label for="inputPrecio">Precio de Vente</label>
						    <input type="number" class="form-control" id="inputPrecio" name="precio" step="0.01" placeholder="0,01" required/>
							<span class="error-formulario" id="errorPrecio" style="font-style: italic; color: red;"></span>
						</div>
                        <button type="button" class="btn btn-success btn-block" id="registrar_producto">Registrar</button>
                    </form>

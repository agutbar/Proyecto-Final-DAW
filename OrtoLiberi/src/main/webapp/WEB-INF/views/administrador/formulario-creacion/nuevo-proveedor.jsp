...
<head>
    ...
    <title>OrtoLiberi - Nuevo Proveedor</title>
...
<body>
    ...
    <section class="wrap" id="new-user">
        <div class="container">
            ...
            <p class="lead">Da de alta a un nuevo proveedor para la empresa</p>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_proveedor" method="post" action="/nuevo/proveedor">
						<div class="form-group">
							<label for="inputCIF">CIF</label>
							<input type="text" class="form-control" id="inputCIF" name="cif" placeholder="Escribe el CIF..." required/>
                        ...
                        <button type="submit" class="btn btn-success btn-block" id="registrar_proveedor">Dar de Alta</button>
                    </form>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/administrador/nuevo-proveedor">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

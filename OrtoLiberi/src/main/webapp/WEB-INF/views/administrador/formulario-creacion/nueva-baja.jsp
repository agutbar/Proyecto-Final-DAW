...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Anotar Baja</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="wrap" id="new-user">
        <div class="container">
            <h1>Anotar Nueva Baja</h1>
            <p class="lead">Registra una nueva baja de un trabajador para que sea tenida en cuenta a la hora de configurar la agenda y los turnos</p>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_baja" method="post" action="/nuevo/baja">
                        <div class="form-group">
                            <label for="inputDiaBaja">Dia de Baja</label>
                            <input type="number" class="form-control" id="inputDiaBaja" name="dia_baja" step="1" placeholder="00" min="1" max="31" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputMesBaja" name="mes_baja" step="1" placeholder="00" min="1" max="12" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputYearBaja" name="year_baja" step="1" placeholder="" min="" required/>
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="inputDiaAlta" name="dia_alta" step="1" placeholder="00" min="1" max="31" required/>
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="inputMesAlta" name="mes_alta" step="1" placeholder="00" min="1" max="12" required/>
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="inputYearAlta" name="year_alta" step="1" placeholder="" min="" required/>
                        ...
                        <div class="form-group">
							...
							<select class="form-control" id="inputTecnico" name="tecnico" required>
						...
						<div class="form-group">
							...
							<select class="form-control" id="inputMotivo" name="motivo" required>
                        ...
                        <button type="submit" class="btn btn-success btn-block" id="registrar_baja">Registrar Baja</button>
                    </form>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/administrador/nueva-baja">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

                ...
                <div class="card-body">
                    <form id="formulario_registro_baja" method="post" action="/nuevo/baja">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputDiaBaja" name="dia-baja" step="1" placeholder="00" min="1" max="31" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputMesBaja" name="mes-baja" step="1" placeholder="00" min="1" max="12" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputYearBaja" name="year-baja" step="1" placeholder="" min="" required/>
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="inputDiaAlta" name="dia-alta" step="1" placeholder="00" min="1" max="31" required/>
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="inputMesAlta" name="mes-alta" step="1" placeholder="00" min="1" max="12" required/>
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="inputYearAlta" name="year-baja" step="1" placeholder="" min="" required/>
                        ...
                        <div class="form-group">
							...
							<select class="form-control" id="inputTecnico" th:field="*{tecnico.id}" required>
                        ...
                        <button type="button" class="btn btn-success btn-block" id="registrar_baja">Registrar Baja</button>
                    </form>

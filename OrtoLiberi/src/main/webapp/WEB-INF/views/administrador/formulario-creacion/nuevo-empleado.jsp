                ...
                <div class="card-body">
                    <form id="formulario_registro_trabajador" method="post" action="/nuevo/trabajador">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputApellidos" name="apellidos" placeholder="Escribe los apellidos..." required/>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/administrador/nuevo-empleado">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

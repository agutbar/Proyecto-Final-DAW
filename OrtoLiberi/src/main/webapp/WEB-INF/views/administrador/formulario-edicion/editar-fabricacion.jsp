                    ...
                    <form id="formulario_editar_fabricacion" method="post" action="/editar/fabricacion">
						<div class="form-group">
							...
							<select class="form-control" id="material" th:field="*{material.id}" required>
								...
								<option th:each="material : ${materiales}" th:value="${material.id}" th:text="${material.nombre}"></option>
							</select>
                        ...
                        <button type="button" class="btn btn-success btn-block" id="editar_fabricacion">Añadir Material</button>
                    </form>

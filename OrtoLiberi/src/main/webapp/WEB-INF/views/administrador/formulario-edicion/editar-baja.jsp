...
<head>
    ...
    <title>OrtoLiberi - Editar Baja</title>
                ...
                <div class="card-body">
                    <form id="formulario_registro_baja" method="post" action="/editar/baja">
						<div class="form-group">
							<label for="inputId" hidden>ID Baja</label>
						    <input type="text" class="form-control" id="inputId" name="id" value="${ausencia.id}" hidden required/>
						</div>
                        <div class="form-group">
                            <label for="inputDiaBaja">Dia de Baja</label>
                            <input type="number" class="form-control" id="inputDiaBaja" name="dia-baja" step="1" min="1" max="31" value="${ausencia.baja.getDayOfMonth()}" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputMesBaja" name="mes-baja" step="1" min="1" max="12" value="${ausencia.baja.getMonthValue()}" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputYearBaja" name="year-baja" step="1" min="" value="${ausencia.baja.getFullYear()}" required/>
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="inputDiaAlta" name="dia-alta" step="1" min="1" max="31" value="${ausencia.alta.getDayOfMonth()}" required/>
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="inputMesAlta" name="mes-alta" step="1" min="1" max="12" value="${ausencia.alta.getMonthValue()}" required/>
						...
						<div class="form-group">
						    ...
						    <input type="number" class="form-control" id="inputYearAlta" name="year-baja" step="1" min="" value="${ausencia.alta.getFullYear()}" required/>
                        ...
                        <button type="submit" class="btn btn-success btn-block" id="registrar_baja">Editar Baja</button>
                    </form>

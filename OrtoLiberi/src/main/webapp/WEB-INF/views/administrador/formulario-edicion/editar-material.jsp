...
<head>
    ...
    <title>OrtoLiberi - Editar Material</title>
...
<body>
    ...
    <section class="wrap" id="new-user">
        <div class="container">
            ...
            <p class="lead">Edita un material ya existente del almacen de la tienda</p>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_material" method="post" action="/editar/material">
						<div class="form-group">
							<label for="inputId" hidden>ID Material</label>
							<input type="text" class="form-control" id="inputId" name="id" value="${material.id}" hidden required/>
						</div>
                        <div class="form-group">
                            <label for="inputNombre">Nombre</label>
                            <input type="text" class="form-control" id="inputNombre" name="nombre" value="${material.nombre}" required/>
							<span class="error-formulario" id="errorNombre" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputDescripcion">Descripción</label>
                            <textarea class="form-control" id="inputDescripcion" name="descripcion" required>${material.descripcion}</textarea>
							<span class="error-formulario" id="errorDescripcion" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputLote">Lote</label>
                            <input type="text" class="form-control" id="inputLote" name="lote" value="${material.lote}" required/>
							<span class="error-formulario" id="errorLote" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputProveedor">Proveedor</label>
							<select class="form-control" id="inputProveedor" name="proveedor" required>
								<option value="${material.proveedor.id}" selected>${material.proveedor.nombre}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputStock" name="stock" value="${material.stock}" required/>
							<span class="error-formulario" id="errorStock" style="font-style: italic; color: red;"></span>
                        </div>
						<div class="form-group">
							<label for="inputCaducidad">Caducidad</label>
						    <input type="date" class="form-control" id="inputCaducidad" name="caducidad" value="${material.caducidad}" required/>
							<span class="error-formulario" id="errorCaducidad" style="font-style: italic; color: red;"></span>
						</div>
                        <div class="form-group">
                            <label for="inputCoste">Coste</label>
                            <input type="number" class="form-control" id="inputCoste" name="coste" step="0.01" value="${material.coste}" required/>
							<span class="error-formulario" id="errorCoste" style="font-style: italic; color: red;"></span>
                        </div>
                        <button type="submit" class="btn btn-success btn-block" id="registrar_material">Actualizar</button>
                    </form>

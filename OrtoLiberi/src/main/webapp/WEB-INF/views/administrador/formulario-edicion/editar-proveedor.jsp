                ...
                <div class="card-body">
                    <form id="formulario_registro_proveedor" method="post" action="/editar/proveedor">
						<div class="form-group">
							<label for="inputId" hidden>ID Proveedor</label>
							<input type="text" class="form-control" id="inputId" name="id" value="${proveedor.id}" hidden required/>
						</div>
						<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="inputEmail" name="correo" value="${proveedor.correo}" required/>
                        ...
                        <button type="submit" class="btn btn-success btn-block" id="registrar_proveedor">Actualizar Datos</button>
                    </form>

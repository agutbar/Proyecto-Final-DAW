...
<head>
    ...
    <title>OrtoLiberi - Editar Trabajador</title>
...
<body>
    ...
    <section class="wrap" id="new-user">
        <div class="container">
            <h1>Editar el perfil del Trabajador</h1>
            <p class="lead">Edita los datos de un trabajador de la empresa. El código que se le asignará deberá ser sus iniciales y los 3 ultimos digitos de su DNI</p>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_trabajador" method="post" action="/edicion/trabajador">
						<div class="form-group">
							<label for="inputId" hidden>ID Trabajador</label>
							<input type="text" class="form-control" id="inputId" name="id" value="${trabajador.id}" hidden required/>
						</div>
                        <div class="form-group">
                            <label for="inputNombre">Nombre</label>
                            <input type="text" class="form-control" id="inputNombre" name="nombre" placeholder="Escribe el nombre..." value="${trabajador.nombre}" required/>
							<span class="error-formulario" id="errorNombre" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputApellidos">Apellidos</label>
                            <input type="text" class="form-control" id="inputApellidos" name="apellidos" placeholder="Escribe los apellidos..." value="${trabajador.apellidos}" required/>
							<span class="error-formulario" id="errorApellidos" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail">Email</label>
                            <input type="email" class="form-control" id="inputEmail" name="correo" placeholder="Escribe un email..." value="${trabajador.correo}" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="inputTelefono" name="telefono" placeholder="Escribe el número de telefono..." value="${trabajador.telefono}" required/>
							<span class="error-formulario" id="errorTelefono" style="font-style: italic; color: red;"></span>
                        </div>
						<div class="form-group">
							<label for="inputFecha">Fecha de Nacimiento</label>
							<input type="date" class="form-control" id="inputFecha" name="nacimiento" placeholder="Escribe la fecha de nacimiento..." value="${trabajador.nacimiento}" required/>
							<span class="error-formulario" id="errorFecha" style="font-style: italic; color: red;"></span>
						</div>
                        <div class="form-group">
                            <label for="inputDireccion">Direccion</label>
                            <input type="text" class="form-control" id="inputDireccion" name="direccion" placeholder="Escribe la direcccion..." value="${trabajador.direccion}" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputCodigo" name="codigo" placeholder="Escribe el código..." value="${trabajador.codigo}" required readonly/>
							<span class="error-formulario" id="errorCodigo" style="font-style: italic; color: red;"></span>
                        </div>
                        <button type="button" class="btn btn-success btn-block" id="registrar_empleado">Editar</button>
                    </form>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/administrador/editar-empleado">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>
	...
	<script src="../js/validacion_edicion_empleado.js"></script>
</body>
</html>
                ...
                <div class="card-body">
                    <form id="formulario_registro_trabajador" method="post" action="/edicion/trabajador">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputApellido" name="apellidos" placeholder="Escribe los apellidos..." value="${trabajador.apellidos}" required/>
							<span class="error-formulario" id="errorApellidos" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail">Email</label>
                            <input type="email" class="form-control" id="inputEmail" name="email" placeholder="Escribe un email..." value="${trabajador.correo}" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password" id="inputPassword" placeholder="Escribe la contraseña..." value="${trabajador.password}" required/>

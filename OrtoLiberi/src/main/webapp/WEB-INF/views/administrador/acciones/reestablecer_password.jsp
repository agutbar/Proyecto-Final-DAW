...
<head>
	...
	<title>OrtoLiberi - Reestablecer contraseña de cliente</title>
...
<body>
    ...
    <section class="wrap" id="login">
        <div class="container">
            <h1>Reestablecer Contraseña de ${cliente.nombre} ${cliente.apellidos}</h1>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_acceso_cliente" method="post" action="/accion/reestablecer-password">
                        <div class="form-group">
                            <label for="inputUser">Nombre de Usuario</label> 
                            <input type="text" class="form-control" id="inputUser" name="usuario" value="${cliente.usuario}" readonly required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="inputPasswordC" name="password" placeholder="Escribe la nueva contraseña..." required/>
							<span class="error-formulario" id="errorPasswordC" style="font-style: italic; color: red;"></span>
                        </div>
                        <button type="button" class="btn btn-success btn-block" id="acceder_cliente">Reestablecer Contraseña</button>
                    </form>

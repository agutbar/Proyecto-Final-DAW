                ...
                <div class="card-body">
                    <form id="formulario_acceso_cliente" method="post" action="/accion/reestablecer-password">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="inputPassword" name="password" placeholder="Escribe la nueva contraseña..." required/>
							<span class="error-formulario" id="errorPassword" style="font-style: italic; color: red;"></span>
                        </div>
                        <button type="submit" class="btn btn-success btn-block" id="acceder_cliente">Reestablecer Contraseña</button>
                    </form>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/cambio/password/${cliente.id}">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

            ...
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_tutor" method="post" action="/accion/reasignar-tutor">
                        ...
                        <button type="submit" class="btn btn-success btn-block" id="cambiar_tutor">Reasignar Tutor</button>
                    </form>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/cambio/tutor/${menor.id}">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

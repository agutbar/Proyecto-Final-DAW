...
<head>
	...
	<title>OrtoLiberi - Reasignar tutor de Paciente</title>
...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Reasignar tutor de un paciente</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="wrap" id="login">
        <div class="container">
            <h1>Reasignar el tutor de ${menor.nombre} ${menor.apellidos}</h1>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_registro_tutor" method="post" action="/accion/reasignar-tutor">
						<div class="form-group">
						    <label for="inputID" hidden>ID Menor</label> 
							<input type="text" class="form-control" id="inputID" name="idMenor" value="${menor.id}" readonly required hidden/>
						</div>
                        <div class="form-group">
                            <label for="inputAntiguo">Antiguo Tutor</label> 
                            <input type="text" class="form-control" id="inputAntiguo" name="antiguo" value="${menor.tutor.id}" placeholder="${menor.tutor.nombre} ${menor.tutor.apellidos}" readonly required/>
							<span class="error-formulario" id="errorAntiguo" style="font-style: italic; color: red;"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputNuevo">Nuevo Tutor</label>
							<select class="form-control" id="inputNuevo" name="nuevo" th:field="*{cliente.id}" required>
							...
							<span class="error-formulario" id="errorNuevo" style="font-style: italic; color: red;"></span>
                        </div>
                        <button type="button" class="btn btn-success btn-block" id="cambiar_tutor">Reasignar Tutor</button>
                    </form>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/general/acceso">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>
	...
	<script src="../js/validacion_acceso_cliente.js"></script>
</body>
</html>
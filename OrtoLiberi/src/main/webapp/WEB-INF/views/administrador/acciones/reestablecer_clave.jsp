...
<head>
	...
	<title>OrtoLiberi - Reestablecer contraseña de empleado</title>
...
<body>
    ...
    <section class="wrap" id="login">
        <div class="container">
            <h1>Reestablecer Contraseña de ${responsable.nombre} ${responsable.apellidos}</h1>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_acceso_empleado" method="post" action="/accion/reestablecer-clave">
                        <div class="form-group">
                            <label for="inputCodigo">Codigo de Empleado</label> 
                            <input type="text" class="form-control" id="inputCodigo" name="usuario" value="${responsable.codigo}" readonly required/>
                        ...
                        <button type="submit" class="btn btn-success btn-block" id="acceder_empleado">Reestablecer Contraseña</button>
                    </form>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/cambio/clave${cliente.id}">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

...
<head>
	...
	<title>OrtoLiberi - Asignar Código</title>
...
<body>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Asignar Código</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="wrap" id="login">
        <div class="container">
            <h1>Asignar Codigo SAS</h1>
            <div class="card">
                <div class="card-body">
                    <form id="formulario_asignacion_codigo" method="post" action="/accion/asignar-codigo">
                        <div class="form-group">
                            <label for="inputID" hidden>ID Producto</label> 
                            <input type="text" class="form-control" id="inputID" name="id" value="${elemento.id}" readonly required hidden/>
                        </div>
						<div class="form-group">
							<label for="inputCategoria" hidden>Categoria</label> 
						    <input type="text" class="form-control" id="inputCategoria" name="categoria" value="${categoria}" readonly required hidden/>
						</div>
                        <div class="form-group">
                            <label for="inputPassword">Codigo para Asignar</label>
                        ...
                        <button type="button" class="btn btn-success btn-block" id="asignar_codigo">Asignar Codigo</button>
                    </form>

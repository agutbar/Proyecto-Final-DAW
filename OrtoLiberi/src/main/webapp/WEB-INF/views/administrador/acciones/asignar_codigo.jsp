            ...
            <div class="card">
                <div class="card-body">
                    <form id="formulario_asignacion_codigo" method="post" action="/accion/asignar-codigo">
                        ...
                        <button type="submit" class="btn btn-success btn-block" id="asignar_codigo">Asignar Codigo</button>
                    </form>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <button type="submit" class="btn btn-success btn-block"><a href="/cambio/codigo/${elemento.id}/${categoria}">Volver</a></button>
                    </form>
                </div>
            </div>
        </div>

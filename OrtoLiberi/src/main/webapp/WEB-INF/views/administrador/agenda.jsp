					...
					<div class="row">
						<div class="col-sm-8 offst-sm-2">
							...
							<div class="tab-content" id="myTabContent">
											...
											<tbody>
												<c:forEach var="cita" items="${citas}">
													<tr>
														<td>${cita.fecha}</td>
														<td>${cita.hora}</td>
														<td>${cita.tecnico.nombre} ${cita.tecnico.apellidos}</td>
														<td>
															<a href="/administrador/editar-cita${cita.id}" class="btn btn-warning btn-sm">Editar</a>
															<a href="/cambio/cita${cita.id}" class="btn btn-success btn-sm">Reasignar Tecnico</a>
														</td>
													</tr>
												</c:forEach>
											</tbody>
								...
								<div class="tab-pane fade" id="asignadas" role="tabpanel" aria-labelledby="citas-asignadas">
							    	<div class="card-heading">
											...
											<tbody>
												<c:forEach var="revision" items="${revisiones}">
													<tr>
														...
														<td>${revision.cita.tecnico.nombre} ${revision.cita.tecnico.apellidos}</td>
														<td>${revision.solicitante.nombre} ${revision.solicitante.apellidos}</td>
														<td>${revision.paciente.nombre} ${revision.paciente.apellidos}</td>
														<td>${revision.descripcion}</td>
														<td>
															<a href="/eliminar/revision/${revision.id}" class="btn btn-warning btn-sm">Cancelar</a>
														</td>
													</tr>
												</c:forEach>
											</tbody>

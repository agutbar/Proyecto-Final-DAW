				                ...
				                <div class="tab-content" id="myTabContent">
				                    <div class="tab-pane fade" id="pclientes" role="tabpanel" aria-labelledby="pedidos-clientes">
				                        <div class="card-heading">
                                            ...
                                            <p><a class="btn btn-primary btn-lg" href="/administrador/nuevo-pedido-cliente">Añadir</a></p>
				                    	</div>
				                    	<div class="card-body">
											<table class="table table-striped">
												...
												<tbody>
													<tr th:each="pedido-cliente: ${pedidos_clientes}">
												    	<td th:text="${pedido-cliente.prevision}"></td>
														<td th:text="${pedido-cliente.prevision}"></td>
														<td th:text="${pedido-cliente.cliente}"></td>
														<td th:text="${pedido-cliente.estado}"></td>
												    	<td>
															<a th:href="/ver/pedido-cliente/{id}(id=${pedido-cliente.id})" class="btn btn-info btn-sm">Ver</a>
												        	<a th:href="/editar/pedido-cliente/{id}(id=${pedido-cliente.id})" class="btn btn-warning btn-sm">Editar</a>
															<a th:href="/estado/pedido-cliente/{id}(id=${pedido-cliente.id})" class="btn btn-success btn-sm">Cambiar Estado</a>
												    	</td>
													</tr>
												</tbody>
											</table>
									...
									<div class="tab-pane fade" id="pproveedor" role="tabpanel" aria-labelledby="pedidos-proveedor">
				                        <div class="card-heading">
                                            ...
                                            <p><a class="btn btn-primary btn-lg" href="/administrador/nuevo-pedido-proveedor">Añadir</a></p>
				                    	</div>
				                    	<div class="card-body">
											<table class="table table-striped">
                                            	<thead>
												...
												<tbody>
													<tr th:each="pedido-proveedor : ${pedidos_proveedores}">
												    	<td th:text="${pedido-proveedor.peticion}"></td>
														<td th:text="${pedido-proveedor.proveedor}"></td>
														<td th:text="${pedido-proveedor.estado}"></td>
														<td>
															<a th:href="/ver/pedido-proveedor/{id}(id=${pedido-proveedor.id})" class="btn btn-info btn-sm">Ver</a>
															<a th:href="/editar/pedido-proveedor/{id}(id=${pedido-proveedor.id})" class="btn btn-warning btn-sm">Editar</a>
															<a th:href="/estado/pedido-proveedor/{id}(id=${pedido-proveedor.id})" class="btn btn-success btn-sm">Cambiar Estado</a>
														</td>
													</tr>
												</tbody>
											</table>

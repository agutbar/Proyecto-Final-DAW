...
<html>
    <head>
		...
		<title>OrtoLiberi - Pagina de Cambio de Estado de Cliente</title>
		...
		<div class="container">
			<div class="row">
		    	<nav class="col-12" aria-label="breadcrumb">
		        	<ol class="breadcrumb">
		            	<li class="breadcrumb-item active" aria-current="page">Cambiar estado de un cliente</li>
		            </ol>
					<p>El estado actual del cliente es ${cliente.estado}</p>
					<form method="post">
						<input type="hidden" name="id" value="${cliente.id}">
						<select class="form-control" id="estado_cliente" required>

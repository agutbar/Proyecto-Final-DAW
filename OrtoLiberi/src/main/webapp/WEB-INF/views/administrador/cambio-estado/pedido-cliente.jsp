...
<html>
    <head>
		...
		<title>OrtoLiberi - Pagina de Cambio de Estado de Pedido de Cliente</title>
		...
		<div class="container">
			<div class="row">
		    	<nav class="col-12" aria-label="breadcrumb">
		        	<ol class="breadcrumb">
		            	<li class="breadcrumb-item active" aria-current="page">Cambiar estado del pedido de un cliente</li>
		            </ol>
					<p>El estado actual del pedido es ${pedido.estado}</p>
					<form method="post">
						<input type="hidden" name="id" value="${pedido.id}">
						<select class="form-control" id="estado_pedido_cliente" required>

...
<html>
    <head>
		...
		<title>OrtoLiberi - Pagina de Cambio de Estado de Trabajador</title>
		...
		<div class="container">
			<div class="row">
		    	<nav class="col-12" aria-label="breadcrumb">
		        	<ol class="breadcrumb">
		            	<li class="breadcrumb-item active" aria-current="page">Cambiar estado de un trabajador</li>
		            </ol>
					<p>El estado actual del trabajador es ${trabajador.estado}</p>
					<form method="post">
						<input type="hidden" name="id" value="${trabajador.id}">
						<select class="form-control" id="estado_trabajador" required>

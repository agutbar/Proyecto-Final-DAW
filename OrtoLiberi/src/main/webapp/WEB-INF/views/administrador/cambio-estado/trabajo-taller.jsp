...
<html>
    <head>
		...
		<title>OrtoLiberi - Pagina de Cambio de Estado de Producto del Taller</title>
		...
		<div class="container">
			<div class="row">
		    	<nav class="col-12" aria-label="breadcrumb">
		        	<ol class="breadcrumb">
		            	<li class="breadcrumb-item active" aria-current="page">Cambiar estado del pedido del taller</li>
		            </ol>
					<p>El estado actual del pedido de fabricación es ${trabajo.estado}</p>
					<form method="post">
						<input type="hidden" name="id" value="${trabajo.id}">
						<select class="form-control" id="estado_pedido_taller" required>
							<option value="">Seleccione un estado</option>
							<option value="en-cola">En Cola</option>
							<option value="fabricando">Fabricando</option>
							<option value="terminado">Terminado</option>
							<option value="entregado">Entregado</option>
							<option value="cancelado">Canceado</option>
						</select>
